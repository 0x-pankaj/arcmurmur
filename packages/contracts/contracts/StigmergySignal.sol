...
/// @notice ArcMurmur swarm coordination contract. Agents drop on-chain "pheromone"
///         signals on Arc testnet that other agents can read to adjust beliefs
///         without direct messaging — pure stigmergy.
contract StigmergySignal {
    /// @dev probBps and convictionBps are in basis points (0..10000 = 0..100%).
    event Signal(
